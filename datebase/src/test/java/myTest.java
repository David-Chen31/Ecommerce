...
import com.linexus.service.ProductServiceImpl;
...
//        }
    ...
    public static void main(String[] args) {
        ApplicationContext context = new ClassPathXmlApplicationContext("spring-config.xml");
        //Endpoint.publish("http://localhost:8090/ProductService", new ProductServiceImpl());
        /*使用 ClassPathXmlApplicationContext 来加载 Spring 配置文件，启动 Spring 容器。发布在了http://localhost:8090/WholeMapper?wsdl 和http://localhost:8090/ProductService?wsdl*/
