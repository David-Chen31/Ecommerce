...
Product::Product():productId(0),productPrice(0),productNum(0),productBuyNum(0),productDiscount(1)
{
    productFlashSalePrice = 0;
    flashSalePurchaseLimit = 0;
    flashSaleStartTime = QDateTime::currentDateTime();
    flashSaleEndTime = QDateTime::currentDateTime();
    discountStartTime = QDateTime::currentDateTime();
    discountEndTime = QDateTime::currentDateTime();
}
