/********************************************************************************
** Form generated from reading UI file 'shop_communication.ui'
**
...
#ifndef UI_SHOP_COMMUNICATION_H
#define UI_SHOP_COMMUNICATION_H
...
public:
    ...
    void setupUi(QWidget *ShopCommunication)
    {
        if (ShopCommunication->objectName().isEmpty())
            ShopCommunication->setObjectName(QString::fromUtf8("ShopCommunication"));
        ShopCommunication->resize(2010, 1060);
        ShopCommunication->setStyleSheet(QString::fromUtf8("/* General UI Styles */\n"
"QWidget {\n"
...
"}\n"
""));
        mainLayout = new QHBoxLayout(ShopCommunication);
        mainLayout->setObjectName(QString::fromUtf8("mainLayout"));
        customerList = new QListWidget(ShopCommunication);
        ...
        emojiButton = new QPushButton(ShopCommunication);
        ...
        messageInputBox = new QTextEdit(ShopCommunication);
        ...
        sendButton = new QPushButton(ShopCommunication);
        ...
        retranslateUi(ShopCommunication);

        QMetaObject::connectSlotsByName(ShopCommunication);
    } // setupUi

    void retranslateUi(QWidget *ShopCommunication)
    {
        ShopCommunication->setWindowTitle(QCoreApplication::translate("ShopCommunication", "\344\270\216\345\256\242\346\210\267\350\201\212\345\244\251", nullptr));
        customerNameLabel->setText(QCoreApplication::translate("ShopCommunication", "\345\256\242\346\210\267\345\220\215\347\247\260\357\274\232\345\274\240\344\270\211", nullptr));
        emojiButton->setText(QCoreApplication::translate("ShopCommunication", "\360\237\230\212", nullptr));
        messageInputBox->setPlaceholderText(QCoreApplication::translate("ShopCommunication", "\350\257\267\350\276\223\345\205\245\346\266\210\346\201\257...", nullptr));
        sendButton->setText(QCoreApplication::translate("ShopCommunication", "\345\217\221\351\200\201", nullptr));
    } // retranslateUi

};

namespace Ui {
    class ShopCommunication: public Ui_ShopCommunication {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_SHOP_COMMUNICATION_H
