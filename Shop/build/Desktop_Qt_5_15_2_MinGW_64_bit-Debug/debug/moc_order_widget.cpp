...
struct qt_meta_stringdata_OrderWidget_t {
    QByteArrayData data[1];
    char stringdata0[12];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_OrderWidget_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_OrderWidget_t qt_meta_stringdata_OrderWidget = {
    {
QT_MOC_LITERAL(0, 0, 11) // "OrderWidget"
...
QT_INIT_METAOBJECT const QMetaObject OrderWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_OrderWidget.data,
    qt_meta_data_OrderWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *OrderWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_OrderWidget.stringdata0))
