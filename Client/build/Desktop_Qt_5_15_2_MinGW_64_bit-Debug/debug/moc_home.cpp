...
QT_MOC_LITERAL(1, 5, 20), // "homeRefreshRequested"
QT_MOC_LITERAL(2, 26, 0) // ""

    },
    "Home\0homeRefreshRequested\0"
};
...
void Home::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->homeRefreshRequested(); break;
        default: ;
        }
        ...
        {
            using _t = void (Home::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Home::homeRefreshRequested)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Home::homeRefreshRequested()
{
