...
public:
    ...
    QPushButton *pushButtonSubsidy;
    QSpacerItem *verticalSpacer;
    QPushButton *pushButtonFlashSale;
    QSpacerItem *verticalSpacer_2;
    QPushButton *pushButtonDeals;
...
"}"));
        ...
        pushButtonSubsidy = new QPushButton(promotionWidget);
        pushButtonSubsidy->setObjectName(QString::fromUtf8("pushButtonSubsidy"));
        QSizePolicy sizePolicy(QSizePolicy::Preferred, QSizePolicy::Preferred);
        sizePolicy.setHorizontalStretch(0);
        sizePolicy.setVerticalStretch(0);
        sizePolicy.setHeightForWidth(pushButtonSubsidy->sizePolicy().hasHeightForWidth());
        pushButtonSubsidy->setSizePolicy(sizePolicy);

        promotionLayout->addWidget(pushButtonSubsidy);

        verticalSpacer = new QSpacerItem(20, 40, QSizePolicy::Expanding, QSizePolicy::Minimum);

        promotionLayout->addItem(verticalSpacer);

        pushButtonFlashSale = new QPushButton(promotionWidget);
        pushButtonFlashSale->setObjectName(QString::fromUtf8("pushButtonFlashSale"));
        sizePolicy.setHeightForWidth(pushButtonFlashSale->sizePolicy().hasHeightForWidth());
        pushButtonFlashSale->setSizePolicy(sizePolicy);

        promotionLayout->addWidget(pushButtonFlashSale);

        verticalSpacer_2 = new QSpacerItem(20, 40, QSizePolicy::Expanding, QSizePolicy::Minimum);

        promotionLayout->addItem(verticalSpacer_2);

        pushButtonDeals = new QPushButton(promotionWidget);
        pushButtonDeals->setObjectName(QString::fromUtf8("pushButtonDeals"));
        sizePolicy.setHeightForWidth(pushButtonDeals->sizePolicy().hasHeightForWidth());
        pushButtonDeals->setSizePolicy(sizePolicy);

        promotionLayout->addWidget(pushButtonDeals);
    ...
    void retranslateUi(QWidget *Promotion)
    {
        ...
        pushButtonSubsidy->setText(QCoreApplication::translate("Promotion", "\347\231\276\344\272\277\350\241\245\350\264\264", nullptr));
        pushButtonFlashSale->setText(QCoreApplication::translate("Promotion", "\351\231\220\346\227\266\347\247\222\346\235\200", nullptr));
        pushButtonDeals->setText(QCoreApplication::translate("Promotion", "\350\226\205\347\276\212\346\257\233", nullptr));
    } // retranslateUi
