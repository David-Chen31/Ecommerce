...
public:
    ...
    void setupUi(QWidget *Communication)
    {
        ...
        Communication->resize(2000, 1000);
        Communication->setStyleSheet(QString::fromUtf8("/* \345\205\250\345\261\200\350\256\276\347\275\256 */\n"
"QWidget {\n"
...
"}\n"
""));
        mainLayout = new QHBoxLayout(Communication);
        mainLayout->setObjectName(QString::fromUtf8("mainLayout"));
        scrollArea = new QScrollArea(Communication);
        scrollArea->setObjectName(QString::fromUtf8("scrollArea"));
        scrollArea->setMaximumSize(QSize(700, 16777215));
        scrollArea->setWidgetResizable(true);
        scrollAreaWidgetContents = new QWidget();
        scrollAreaWidgetContents->setObjectName(QString::fromUtf8("scrollAreaWidgetContents"));
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 698, 980));
        QSizePolicy sizePolicy(QSizePolicy::Minimum, QSizePolicy::Preferred);
        sizePolicy.setHorizontalStretch(0);
        sizePolicy.setVerticalStretch(0);
        sizePolicy.setHeightForWidth(scrollAreaWidgetContents->sizePolicy().hasHeightForWidth());
        scrollAreaWidgetContents->setSizePolicy(sizePolicy);
        scrollAreaWidgetContents->setMaximumSize(QSize(700, 16777215));
        ...
        contactList = new QListWidget(scrollAreaWidgetContents);
        contactList->setObjectName(QString::fromUtf8("contactList"));
        QSizePolicy sizePolicy1(QSizePolicy::Preferred, QSizePolicy::Expanding);
        sizePolicy1.setHorizontalStretch(0);
        sizePolicy1.setVerticalStretch(0);
        sizePolicy1.setHeightForWidth(contactList->sizePolicy().hasHeightForWidth());
        contactList->setSizePolicy(sizePolicy1);
        contactList->setMaximumSize(QSize(700, 16777215));

        scrollAreaLayout->addWidget(contactList);
        ...
        titleLabel = new QLabel(Communication);
        titleLabel->setObjectName(QString::fromUtf8("titleLabel"));

        rightLayout->addWidget(titleLabel);

        messageScrollArea = new QScrollArea(Communication);
        ...
        scrollContent->setGeometry(QRect(0, 0, 1272, 583));
        messageLayout = new QVBoxLayout(scrollContent);
        messageLayout->setObjectName(QString::fromUtf8("messageLayout"));
        messageLabel = new QLabel(scrollContent);
        ...
        rightLayout->addWidget(messageScrollArea);

        emojiButton = new QPushButton(Communication);
        ...
        emojiButton->setIconSize(QSize(23, 22));

        rightLayout->addWidget(emojiButton);

        bottomLayout = new QHBoxLayout();
        bottomLayout->setObjectName(QString::fromUtf8("bottomLayout"));
        inputBox = new QTextEdit(Communication);
        ...
        inputBox->setMinimumSize(QSize(0, 300));

        bottomLayout->addWidget(inputBox);

        sendButton = new QPushButton(Communication);
    ...
    {
        Communication->setWindowTitle(QCoreApplication::translate("Communication", "Communication", nullptr));
        titleLabel->setText(QCoreApplication::translate("Communication", "\345\225\206\345\256\266\345\220\215\347\247\260", nullptr));
        messageLabel->setText(QCoreApplication::translate("Communication", "\347\244\272\344\276\213\346\266\210\346\201\257\345\206\205\345\256\271", nullptr));
        emojiButton->setText(QCoreApplication::translate("Communication", "\360\237\230\212", nullptr));
        inputBox->setPlaceholderText(QCoreApplication::translate("Communication", "\350\257\267\350\276\223\345\205\245\346\266\210\346\201\257...", nullptr));
        sendButton->setText(QCoreApplication::translate("Communication", "\345\217\221\351\200\201(S)", nullptr));
    } // retranslateUi
