...
QT_MOC_LITERAL(1, 8, 14), // "contactClicked"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 6), // "shopId"
QT_MOC_LITERAL(4, 31, 8) // "shopName"

    },
    "Contact\0contactClicked\0\0shopId\0shopName"
};
...
void Contact::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->contactClicked((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Contact::*)(int , const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Contact::contactClicked)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Contact::contactClicked(int _t1, const QString & _t2)
{
