...
"    border-radius: 5px; /* \345\234\206\350\247\222 */\n"
"    padding: 5px;\n"
"    font-size: 20px; /* \345\233\276\346\240\207\345\244\247\345\260\217 */\n"
...
""));
        ...
        contactList = new QListWidget(Communication);
        contactList->setObjectName(QString::fromUtf8("contactList"));
        QSizePolicy sizePolicy(QSizePolicy::Minimum, QSizePolicy::Expanding);
        sizePolicy.setHorizontalStretch(0);
        sizePolicy.setVerticalStretch(0);
        sizePolicy.setHeightForWidth(contactList->sizePolicy().hasHeightForWidth());
        contactList->setSizePolicy(sizePolicy);
        contactList->setMinimumSize(QSize(450, 0));
        ...
        messageArea = new QWidget(Communication);
