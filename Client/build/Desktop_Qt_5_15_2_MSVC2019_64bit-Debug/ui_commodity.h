...
""));
        ...
        widget_4->setGeometry(QRect(190, 720, 431, 121));
        ...
        ShopName = new QLabel(merchantWidget);
        ShopName->setObjectName(QString::fromUtf8("ShopName"));
        QSizePolicy sizePolicy(QSizePolicy::Expanding, QSizePolicy::Expanding);
        sizePolicy.setHorizontalStretch(0);
        sizePolicy.setVerticalStretch(0);
        sizePolicy.setHeightForWidth(ShopName->sizePolicy().hasHeightForWidth());
        ShopName->setSizePolicy(sizePolicy);

        gridLayout->addWidget(ShopName, 0, 1, 1, 1);
        ...
        pushButton->setGeometry(QRect(1780, 800, 111, 61));
    ...
    void retranslateUi(QWidget *Commodity)
    {
        ...
        ShopName->setText(QCoreApplication::translate("Commodity", "\345\272\227\351\223\272\345\220\215\347\247\260\357\274\232  \345\276\267\350\212\231", nullptr));
